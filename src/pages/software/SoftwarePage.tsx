			...
			<IonContent>
				...
				>
					<SectionItem
						...
						subtitle='Senior Application Architect, 2/2016 to Present'
						extra='Remote'
					...
					<SectionItem
						...
						subtitle='Senior Software Engineer, 10/2013 to 10/2015'
						extra='Remote'
					...
					<SectionItem
						isImageRight={false}
						title='Freelance'
						subtitle='Software Engineer, 11/2008 to 10/2013'
						extra='Remote'
